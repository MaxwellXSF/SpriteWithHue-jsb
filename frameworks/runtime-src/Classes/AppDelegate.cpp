...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("Example");
#else
        glview = cocos2d::GLViewImpl::createWithRect("Example", Rect(0,0,900,640));
#endif
	...
	sc->addRegisterCallback(register_all_sj);
